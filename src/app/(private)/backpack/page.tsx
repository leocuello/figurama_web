...
export default function CollectionPage() {
    ...
    const getProgress = (coleccionadas: number, total: number) => {
        return Math.round((coleccionadas / total) * 100)
    }

    if (error) {
        const message = "Error al obtener la lista de albumes"
    ...
    return (
        <AuthGuard>
            <div className="z-10" style={{ backgroundColor: "white", color: "black", padding: "20px"}}>
                ...
                >
                    {collections.map((collection) => {
                        ...
                        const progress = getProgress(found, total)
